...
public class CPU(Memory memory, Registers registers, IRandomNumberGenerator random, IKeyboard keyboard, IScreen screen, IAudio audio)
{
    ...
    public int EmulateCycle()
    {
        ...
        int opcode = this.memory.GetOpcode(this.pc) & 0xFFFF;
        ...
        switch (opcode & 0xF000)
        {
            case 0x0000:
                switch (opcode)
                {
                    ...
                    default:
                        throw new NotSupportedException($"OpCode '{opcode:X4}' is not supported!");
                }
            ...
            case 0xF000:
                ...
                switch (opcode & 0x00FF)
                {
                    ...
                    case 0x009: // Sets I to the location of the sprite for the character in vx. Characters 0-F (in hexadecimal) are represented by a 4x5 font.
                        this.i = 0x50 + (vx * 5);
                        return 91;
