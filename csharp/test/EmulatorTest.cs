...
public class EmulatorTest
{
    ...
    private Chip8.Registers registers;
    ...
    public EmulatorTest() {
        ...
        cpu = new Chip8.CPU(memory, registers, random, keyboard, screen);
    }
    ...
    void ShouldTestOpcode0x1XXX() {
        ...
        Assert.Equal("1", registers[0].ToString("X"));
    }
    ...
    void ShouldTestOpcode0x8XY0() {
        ...
        cpu.EmulateCycle();
        Assert.Equal("2", registers[0].ToString("X"));
    }
